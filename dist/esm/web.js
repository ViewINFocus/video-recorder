...
export class VideoRecorderWeb extends WebPlugin {
    ...
    async initialize(options) {
        ...
        let hasAudio = !(options === null || options === void 0 ? void 0 : options.disableAudio);
        if (navigator.mediaDevices.getUserMedia) {
            try {
                this.stream = await navigator.mediaDevices.getUserMedia({ video: true, audio: !(options === null || options === void 0 ? void 0 : options.disableAudio) });
                this.videoElement.srcObject = this.stream;
            }
            catch (_c) {
                // Mic denied or unavailable — fallback to video-only
                try {
                    ...
                    // Camera also denied — nothing we can do
                }
            }
        }
        return { hasAudio };
